...
function ZoomInSolid(allProps: IconWrapperProps): React.ReactElement {
  ...
  return (
    <IconWrapper
      icon={
        ...
        >
          <g fill="#11181C">
            <path d="M9.5 14.5a1 1 0 0 1-1-1v-2h-2a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h2v-2a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v2h2a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-2v2a1 1 0 0 1-1 1z" />
            <path
              fillRule="evenodd"
